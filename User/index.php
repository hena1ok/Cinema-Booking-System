    ...
    <section class="hero">
      <div class="slider">
        <div class="slide active">
          ...
          <a href="schedule.php" class="btn-book-now">Book Now</a>
        </div>
        <div class="slide">
        ...
        <div class="slide">
          ...
          <a href="../Admin/Author/signup.php" class="btn-book-now">Join Now</a>
        </div>
      </div>
        ...
        <div class="movies">
          ...
          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
              ...
              echo '<img src="../Assets/ScheduleAssets/Images/' . $row['Image'] . '" alt="' . $row['Title'] . '">';
