    ...
    <div class="header__content">
      ...
      <nav class="navbar">
        <ul class="nav__list">
          ...
          <li class="nav__item"><a href="../Movies/indexMovie.php" class="nav__link">Movies</a></li>
          <li class="nav__item"><a href="../Schedules/indexSchedule.php" class="nav__link">Schedules</a></li>
          <li class="nav__item"><a href="#" class="nav__link">Tickets</a></li>
          <li class="nav__item"><a href="../Users/indexUser.php" class="nav__link">Users</a></li>
